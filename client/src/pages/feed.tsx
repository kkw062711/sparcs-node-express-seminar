...
const FeedPage = (props: {}) => {
  ...
  const modifyPost = (id: string) => {
    const asyncFun = async () => {
      let modifiedTitle = prompt("New Title : ")
      let modifiedContent = prompt("New Content : ")
      await axios.post( SAPIBase + '/feed/modifyFeed', {id:id, title: modifiedTitle, content: modifiedContent } );
    };
    asyncFun().catch(e => window.alert(`AN ERROR OCCURED! ${e}`));
  }
